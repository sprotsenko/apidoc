---
apiurl: '/statuses'
title: 'Get all statuses by list of barcodes'
type: 'POST'

layout: default
---

This method allows the user to retrieve all statuses from the list of barcodes. You can send up to 50 barcodes in a request.
...
[  
   ...
   {  
      ...
      "name":"DKD ODESSA",
      "event":21500,
      "eventName":“Sending to the branch office",
      "country":"Ukraine",
      "eventReason":null,
      "eventReason_id":1,
      "mailType":1048576,
